...
export enum ArgType { NUMBER, POSITIVE_NUMBER, BOOLEAN, COLOR, MESH_HANDLE, LIST_OF_MESH_HANDLE, POLYGON2D, VEC2, NONNEGATIVE_INTEGER, POSITIVE_INTEGER }
...
let preambleFunctions: FuncSpec[] = [
    ...
    args: [
        { argname: "objects", argtype: [ArgType.MESH_HANDLE,ArgType.LIST_OF_MESH_HANDLE], defaultValue: undefined, doc: "A list of the objects for the computation." },
        { argname: "color", argtype: [ArgType.COLOR], defaultValue: "None", doc: "Color for the object; if None, use the color of the first object in the list" },
    ]
    },
    {
