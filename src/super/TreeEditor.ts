import { addAddObjectListener, addObjectToDepot, getUniqueNameForObject } from "./ObjectDepot.js";
...
export class TreeEditor{
    ...
    constructor(treeContainer: HTMLElement, propertyContainer: HTMLElement){
        ...
        addAddObjectListener( (obj: GeometricObject) => {
            ...
            console.log("FIXME: Don't hardcode to cylinder!");
            var newnodedata = new TreeNode(obj.name, obj.iconName,
                obj);

            var newnodeid = $(div).jstree().create_node(
                "#",       //parent
                newnodedata,     //data for node
        ...
        let cyl = new Cylinder(getUniqueNameForObject("cylinder"),new Point3(0,0,0),1,1);
        addObjectToDepot( cyl );

        let cube = new Box(getUniqueNameForObject("box"),new Point3(1,0,0),1,1,1);
        addObjectToDepot( cube );
    }
}
