...
def makeDocFile(shimfiles):
    ...
    with open(docfile,"w") as fp:
        ...
        print(file=fp)
        print(file=fp)
        print(f"//This file is autogenerated by {__file__}. Do not edit.",file=fp)
        print(file=fp)
        print(file=fp)
...
typeNameMap = {
    ...
    "COLOR": ("color", "a color (a 3-tuple of integers 0...255, a 4-tuple of integers 0...255, or a string like \"red\" or \"black\")"),
